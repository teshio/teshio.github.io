...
<p class="contact-intro">Tell me what you're building and I’ll get back to you soon.</p>
...
<form id="contactForm" method="POST">
  ...
  <textarea name="message" rows="8" placeholder="Your message" required></textarea><br>
